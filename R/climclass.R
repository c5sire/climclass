...
#'
#' Tools for climate classification. The Walter-Lieth climate chart is a slightly
#' modified version from the climtol package.
#'
#' @name climclass-package
#' @docType package
NA
...
# 
# 
# climclass <- function(data,type=c("Koeppen")){
#   
# }
# 
